...
public class JdbcUserDao implements UserDao {
    ...
    public List<User> getUsers() {
        ...
        String sql = "SELECT user_id, username, email, password_hash, role FROM users";
        try {
    ...
    public User getUserByUsername(String username) {
        ...
        User user = null;
        String sql = "SELECT user_id, username, email, password_hash, role FROM users WHERE username = LOWER(TRIM(?));";
        try {
